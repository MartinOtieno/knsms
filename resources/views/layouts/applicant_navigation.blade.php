<nav x-data="{ open: false }" class="bg-white border-b border-gray-100">
            ...
            <div class="flex">
                ...
                <div class="shrink-0 flex items-center">
                    <a href="{{ route('applicant.dashboard') }}">
                        ...
                        <h1 class="logo me-auto"><a href="('/')"> <img src="/images/kibulogo.png" alt="logo" style="width: 55px;"></a></h1>
                    </a>
                </div>
                ...
                <div class="hidden space-x-8 sm:-my-px sm:ms-10 sm:flex">
                    ...
                    <x-nav-link :href="route('students.apply')" :active="request()->routeIs('dashboard')">
                        {{ __('Apply Now') }}
                    </x-nav-link>
                ...
                <x-dropdown align="right" width="48">
                    ...
                    <x-slot name="content">
                        ...
                        <form method="POST" action="{{ route('applicant.logout') }}">
                            ...
                            <x-dropdown-link :href="route('applicant.logout')"
    ...
    <div :class="{'block': open, 'hidden': ! open}" class="hidden sm:hidden">
        <div class="pt-2 pb-3 space-y-1">
            <x-responsive-nav-link :href="route('applicant.dashboard')" :active="request()->routeIs('dashboard')">
                {{ __('Dashboard') }}
        ...
        <div class="pt-4 pb-1 border-t border-gray-200">
            ...
            <div class="mt-3 space-y-1">
                ...
                <form method="POST" action="{{ route('applicant.logout') }}">
                    ...
                    <x-responsive-nav-link :href="route('applicant.logout')"
                            onclick="event.preventDefault();
                                        this.closest('form').submit();">
                        {{ __('Log Out') }}
                    </x-responsive-nav-link>
